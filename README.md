...
| `numerical-final.pdf` | PDF version of `numerical.ipynb` |
| `numerical.ipynb` | Jupyter notebook demonstrating the experiment |
| `output.png` | Result generated by `numerical.ipynb` |
